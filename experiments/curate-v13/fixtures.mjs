...
export const fixtures = [
  ...
  { name: 'landscape-couple-solo-same-backdrop', photos: [photo('landscape', 0, { people: 0 }),
    photo('couple', 5, { people: 2, recognized: ['person-a', 'person-b'] }),
    photo('solo', 10, { people: 1, recognized: ['person-a'] })], expected: [['landscape'], ['couple'], ['solo']] },
  { name: 'landscape-couple-solo-without-thumbnail', photos: [photo('landscape', 0, { people: 0, thumbhash: null }),
    photo('couple', 5, { people: 2, recognized: ['person-a', 'person-b'], thumbhash: null }),
    photo('solo', 10, { people: 1, recognized: ['person-a'], thumbhash: null })], expected: [['landscape'], ['couple'], ['solo']] },
