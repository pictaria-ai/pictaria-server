...
test('performance API validates limits and empty state without depending on Prometheus or Immich', async t => {
  ...
  for (const value of ['0', '1001', 'NaN', '3.5', '-1']) await assert.rejects(get(`/api/enrich/performance?limit=${value}`), {
    message: 'Performance comparisons must contain 1–1000 setups.',
  });
